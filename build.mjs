...
const PARTES = [
  ...
  SEP('\n</style>\n\n<style id="anki-product-parity">\n'), S('css/33-anki-product-parity.css'),
  SEP('\n</style>\n\n<style id="anki-image-occlusion">\n'), S('css/34-anki-image-occlusion.css'),
  SEP('\n</style>\n\n<style id="anki-max-reviewer-browser">\n'), S('css/35-anki-max-reviewer-browser.css'),
  SEP('\n</style>\n\n<style id="anki-max-editor">\n'), S('css/36-anki-max-editor.css'),
  SEP('\n</style>\n\n<style id="anki-max-image-occlusion">\n'), S('css/37-anki-max-image-occlusion.css'),
  SEP('\n</style>\n\n<style id="anki-max-stats-media">\n'), S('css/38-anki-max-stats-media.css'),
  SEP('\n</style>\n\n<style id="anki-total-parity">\n'), S('css/39-anki-total-parity.css'),
  SEP('\n</style>\n\n<style id="anki-practical-10">\n'), S('css/40-anki-practical-10.css'),
  SEP('\n</style>\n\n<style id="anki-official">\n'), S('css/41-anki-official.css'),
  SEP('\n</style>\n\n<style id="anki-official-surfaces">\n'), S('css/42-anki-official-surfaces.css'),
  SEP('\n</style>\n\n<style id="telas-tec-extras">\n'), S('css/43-telas-tec-extras.css'),
  SEP('\n</style>\n\n<style id="telas-cards">\n'), S('css/44-telas-cards.css'),
  SEP('\n</style>\n\n<style id="grade-gerador">\n'), S('css/45-grade-gerador.css'),
  SEP('\n</style>\n\n<style id="telas-estudo">\n'), S('css/46-telas-estudo.css'),
  SEP('\n</style>\n\n<style id="padrao-global">\n'), S('css/47-padrao-global.css'),
  SEP('\n</style>\n\n<style id="abertura">\n'), S('css/48-abertura.css'),
  SEP('\n</style>\n\n<style id="grade-painel">\n'), S('css/49-grade-painel.css'),
  SEP('\n</style>\n\n<script id="app-code" type="application/x-diario-inert">\n'),
  [
    'js/10-infra.js','js/11-db.js','js/12-planos-perfis.js','js/14-navegacao-e-dialogos.js','js/15-saveguard.js','js/16-planilhas-e-tec.js','js/17-reforco.js','js/20-tela-registrar.js','js/21-tela-ciclo.js','js/22-leis-engine.js','js/30-fsrs.js','js/31-cards-config.js','js/32-card-engine.js','js/34-anki-export.js','js/35-anki-import.js','js/33-tela-grade.js','js/33-grade-gerador.js','js/40-tela-historico.js','js/41-tela-evolucao.js','js/42-tela-estudo-novo.js','js/43-tela-leis.js','js/44-tela-cards.js','js/44-anki-parity.js','js/44-anki-runtime.js','js/44-anki-product-parity.js','js/44-anki-image-occlusion.js','js/44-anki-max-reviewer-browser.js','js/44-anki-max-editor.js','js/44-anki-max-image-occlusion.js','js/44-anki-max-stats-media.js','js/44-anki-10of10-final.js','js/44-anki-total-parity.js','js/44-anki-practical-10.js','js/44-anki-official.js','js/45-anki-official-surfaces.js','js/45-autoteste.js','js/46-sanitizacao-e-editor.js','js/47-tela-extras.js','js/48-tela-links.js','js/49-tela-config.js','js/50-tela-ferramentas.js','js/51-tela-desempenho-tec.js','js/52-tela-planejamentos.js','js/53-portao-de-acesso.js','js/54-reforco-fila.js','js/55-extras-ui-moderna.js','js/56-leis-rodizio.js','js/57-extras-lei-fonte.js','js/58-extras-governanca.js','js/59-tec-premium.js','js/59-extras-central-ui.js','js/59-extras-stability.js','js/59-interaction-feedback.js','js/59-extras-ux100.js','js/60-cloud-store.js','js/60-relational-store.js','js/63-cloud-ui.js','js/64-info-tips.js','js/66-backup-nuvem.js','js/67-atualizacao.js','js/70-relatorio.js','js/80-ajustes-finais.js','js/81-ux-stability.js','js/82-startup-spinners-reforco-continuo.js','js/86-motor-sugestao.js','js/87-motor-ciclo.js','js/93-ux-hierarquia.js','js/94-global-scope.js'
