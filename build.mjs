...
const PARTES = [
  ...
  SEP('\n</style>\n\n<style id="startup-spinners-reforco">\n'), S('css/21-startup-spinners-reforco-continuo.css'),
...
if (process.argv.includes('--check')) {
  ...
  console.error('Se foi feita em src/, rode `node build.mjs` para regravar.');
  process.exit(1);
}
