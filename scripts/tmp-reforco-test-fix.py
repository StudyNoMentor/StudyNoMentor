...
# Array.from é obrigatório aqui porque o motor é carregado em vm.Context e seus
# arrays pertencem a outro realm; deepStrictEqual rejeita protótipos diferentes.
